...
import project.stn991524577_991473606.tszKinNikita.databinding.FragmentAddSwimmingBinding
 ...
 * Use the [AddSwimmingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AddSwimmingFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    val args: WorkoutListFragmentArgs by navArgs()
    val fireStoreDatabase = FirebaseFirestore.getInstance()
    private var _binding: FragmentAddSwimmingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddSwimmingBinding.inflate(inflater, container, false)

        val view = binding.root


        binding.addButton.setOnClickListener {
            var action = AddSwimmingFragmentDirections.actionAddSwimmingFragmentToWorkoutListFragment(args.userId)
            ...
            if (date.isNullOrEmpty() || distance.equals(null)  || time.equals(null)){
                ...
                fireStoreDatabase.collection("swimmingWorkouts")
                    .add(climbingWorkout)
    ...
    companion object {
         ...
         * @return A new instance of fragment AddSwimmingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AddSwimmingFragment().apply {
